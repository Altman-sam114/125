...
| v5.8a-v5.8j | 进行中 | AI 面板、外交面板、战报日志、MapEditor 默认路径、README/plan/flow 文档定位、主游戏 DataLoader 默认启动 fallback、唐宋将领注册表默认路径、命令反馈/战报元数据和检查面板 raw id / 目标状态已做默认主路径硬化首轮。完整 RC 审计仍未完成。 |
