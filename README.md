...
> **v5.5 最新小切片：** 默认唐宋主界面的 HUD、图层、观战、面板 tabs、军令按钮和战报分类已加入唐宋场景显示桥，显示为回合、政权、阶段、胜负、地块、州府、方面、军队、将领、战报、府库、军议、固守、整补、围城和粮道等读法。该切片只改玩家可见术语，不改变底层 raw case、命令、日志结构或规则执行；完整地图美术、棋子符号、截图和布局验收仍待后续。
