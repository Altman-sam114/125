...
> **v5.5 最新小切片：** 默认唐宋主界面的 HUD、图层、观战、面板 tabs、军令按钮和战报分类已加入唐宋场景显示桥，显示为回合、政权、阶段、胜负、地块、州府、方面、军队、将领、战报、府库、军议、固守、整补、围城和粮道等读法；SpriteKit 地图新增唐宋视觉 token，唐宋场景使用墨绿底、绢帛/青绿/石青/铜/朱印色系、赭石道路、石青河流、朱印/青绿势力色，棋子从 NATO 符号切为内置军旗轮廓和禁/骑/弩/械/守/军兵种字标。该切片只改玩家可见术语与视觉读法，不改变底层 raw case、命令、日志结构或规则执行；完整截图、布局验收、外部美术资产和授权清单仍待后续。
