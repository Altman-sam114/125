...
> **v5.7h 最新小切片：** 唐宋场景现在可以在 HUD 下方切换当前亲征阵营并配合观战模式运行；这是基于现有 `.allies/.germany` 兼容桥的轻量入口，仍不是完整多政权选择器、持久化配置或多国数据驱动回合系统。
...
└── prompt/
    ...
    ├── v5.0-唐宋迁移/
    │   唐宋 v5.0-v5.9 总提示词、v5.0 审计合同、v5.7a 下一步提示、v5.7b 目标锚点、v5.7c 目标定位、v5.7d 地图目标高亮、v5.7e 战报摘要、v5.7f 新局身份包装、v5.7g 高亮数量提示、v5.7h 亲征/观战入口等阶段记录
    ├── v2.0-三国迁移/
    ├── v3.0-拿战迁移/
    ├── v3.0-隋唐迁移/
    ├── v4.0-明末迁移/
