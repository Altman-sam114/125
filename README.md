...
> **v5.7e 最新小切片：** 战报面板现在会只读汇总本回合或最近回合的战事、围城、粮道、外交、州府变化和军议摘要；这补足了 v5.7d 的地图导览，但仍不是完整结算页、评分系统或教程任务链。
...
└── prompt/
    ...
    ├── v5.0-唐宋迁移/
    │   唐宋 v5.0-v5.9 总提示词、v5.0 审计合同、v5.7a 下一步提示、v5.7b 目标锚点、v5.7c 目标定位、v5.7d 地图目标高亮、v5.7e 战报摘要等阶段记录
    ├── v2.0-三国迁移/
    ├── v3.0-拿战迁移/
    ├── v3.0-隋唐迁移/
    ├── v4.0-明末迁移/
