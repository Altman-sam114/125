...
> **v5.7d 最新小切片：** 地图现在会以“已据/待取”spotlight 标出主要统一目标州府，HUD 目标按钮仍负责选中聚焦；这补足了 v5.7c 的选区定位，但仍不是自动镜头移动、路线指引、完整教程或持续目标追踪系统。
...
└── prompt/
    ...
    ├── v5.0-唐宋迁移/
    │   唐宋 v5.0-v5.9 总提示词、v5.0 审计合同、v5.7a 下一步提示、v5.7b 目标锚点、v5.7c 目标定位、v5.7d 地图目标高亮等阶段记录
    ├── v2.0-三国迁移/
    ├── v3.0-拿战迁移/
    ├── v3.0-隋唐迁移/
    ├── v4.0-明末迁移/
