...
> **v5.7g 最新小切片：** “下一步”现在不再只给泛化行动建议；选中可行动宋军后，会基于当前地图高亮说明可攻击目标数和可行军格数。这仍不是完整教程系统或 CommandValidator dry-run 合法性面板。
...
└── prompt/
    ...
    ├── v5.0-唐宋迁移/
    │   唐宋 v5.0-v5.9 总提示词、v5.0 审计合同、v5.7a 下一步提示、v5.7b 目标锚点、v5.7c 目标定位、v5.7d 地图目标高亮、v5.7e 战报摘要、v5.7f 新局身份包装、v5.7g 高亮数量提示等阶段记录
    ├── v2.0-三国迁移/
    ├── v3.0-拿战迁移/
    ├── v3.0-隋唐迁移/
    ├── v4.0-明末迁移/
