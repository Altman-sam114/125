...
> **v5.7f 最新小切片：** HUD 现在会说明当前是玩家亲征还是观战、宋军是否可下令，并为“重开剧本”增加确认；这补足了 v5.7e 的战报可读性，但仍不是完整势力选择、存档槽或发布级新局向导。
...
└── prompt/
    ...
    ├── v5.0-唐宋迁移/
    │   唐宋 v5.0-v5.9 总提示词、v5.0 审计合同、v5.7a 下一步提示、v5.7b 目标锚点、v5.7c 目标定位、v5.7d 地图目标高亮、v5.7e 战报摘要、v5.7f 新局身份包装等阶段记录
    ├── v2.0-三国迁移/
    ├── v3.0-拿战迁移/
    ├── v3.0-隋唐迁移/
    ├── v4.0-明末迁移/
