...
**你接手时的代码库状态：**
- 当前主线是唐宋 v5.x 迁移，默认剧本为 `jianlong_960_unification`；v5.8ao 已把古代作战模型方向写入 README / AGENTS，并完成骑军冲击、断粮出击限制和接触带口径首轮。最新推送按 GitHub Actions 云端验证与 artifact 核对为准。
