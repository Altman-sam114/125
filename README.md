...
> **v5.7c 最新小切片：** 首屏 HUD “目标”锚点现在可点击定位目标州府，点击只更新选中 hex / region，复用现有地图选中和州府面板；这补足了 v5.7b 的文字锚点，但仍不是完整教程系统、自动镜头移动或目标高亮层。
...
└── prompt/
    ...
    ├── v5.0-唐宋迁移/
    │   唐宋 v5.0-v5.9 总提示词、v5.0 审计合同、v5.7a 下一步提示、v5.7b 目标锚点、v5.7c 目标定位等阶段记录
    ├── v2.0-三国迁移/
    ├── v3.0-拿战迁移/
    ├── v3.0-隋唐迁移/
    ├── v4.0-明末迁移/
