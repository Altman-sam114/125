...
> **v5.7b 最新小切片：** 首屏 HUD 现在会显示“目标”锚点，把主要统一目标拆成已据和待取关键州府；这补足了 v5.7a 的“下一步”提示，但仍不是完整教程系统、地图定位或目标高亮。
...
└── prompt/
    ...
    ├── v5.0-唐宋迁移/
    │   唐宋 v5.0-v5.9 总提示词、v5.0 审计合同、v5.7a 下一步提示、v5.7b 目标锚点等阶段记录
    ├── v2.0-三国迁移/
    ├── v3.0-拿战迁移/
    ├── v3.0-隋唐迁移/
    ├── v4.0-明末迁移/
