...
| v5.7 | 教程、剧本包装与可玩闭环 | 已开始：v5.7a 下一步提示、v5.7b 统一目标锚点、v5.7c 目标定位、v5.7d 地图目标 spotlight、v5.7e 每回合战报摘要、v5.7f 新局/指挥身份包装、v5.7g 高亮数量提示、v5.7h 亲征/观战入口、v5.7i 结算预览/评分估算首轮 | 开局引导、势力选择、战报、新局/重置，让普通玩家能完成首发剧本 | `v5.7a_next_action_hint_record.md`、`v5.7b_objective_anchor_record.md`、`v5.7c_objective_focus_record.md`、`v5.7d_objective_spotlight_record.md`、`v5.7e_turn_report_summary_record.md`、`v5.7f_new_game_identity_observer_record.md`、`v5.7g_next_action_highlight_counts_record.md`、`v5.7h_start_power_observer_entry_record.md`、`v5.7i_victory_settlement_score_summary_record.md`、`v5.7_playable_loop_record.md` |
...
v5.7 可玩闭环已从最小首屏提示切入。当前 v5.7a/v5.7b/v5.7c/v5.7d/v5.7e/v5.7f/v5.7g/v5.7h/v5.7i 已完成：
