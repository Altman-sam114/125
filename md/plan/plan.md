...
| P3 | 围城 AI 解释文案 | 已完成首轮：AI 面板在唐宋场景显示军议、方面军令和唐宋战术名；simulated marshal strategicIntent、summary 与 rationale 已转为宋枢密院/割据行营、州府和粮道口径；后续仍可继续细分围城/修城/解围/招降原因 | `v5.3_rules_siege_grain_record.md`、`v5.4_agent_schema_record.md` | 不改变 AI 执行权限；解释文案不能替代规则结果 |
